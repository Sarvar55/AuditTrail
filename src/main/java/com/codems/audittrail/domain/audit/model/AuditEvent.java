...
public class AuditEvent {
    ...
    private AuditEvent(Long actorId, AuditAction actionType, AuditResourceType resourceType,
    ...
    public static AuditEvent create(Long actorId, AuditAction actionType, AuditResourceType resourceType,
                                    String resourceId, String ipAddress) {
